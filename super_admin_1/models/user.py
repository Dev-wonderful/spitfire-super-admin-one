...
class Users(BaseModel):
    ...
    def __init__(self, username, first_name, last_name, email, phone_number, roleId, section_order, password, provider, profile_pic, profile_cover_photo, refresh_token, location, country, is_verified=False, two_factor_auth=False):
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"refresh_token={self.refresh_token}, roleId={self.roleId}, "
