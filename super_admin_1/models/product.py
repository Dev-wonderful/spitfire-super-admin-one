...
class Product(BaseModel):
    ...
    admin_status = db.Column(db.Enum('pending', 'reviewed', 'approved', 'blacklisted',
                             'suspended', name="ADMIN_STATUS"), server_default="pending", nullable=False)
    is_deleted = db.Column(db.Enum(
        "active", "temporary", name="product_status"), server_default="active", nullable=False)
